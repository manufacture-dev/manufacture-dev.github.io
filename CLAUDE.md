...
**YOU ARE IN: `website/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/website/` (rig root) or other directories
...
**Your mail address:** `website/polecats/furiosa`
**Your rig:** website
**Your Witness:** `website/witness`
...
| Ask Witness for help | `gt mail send website/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`website/witness`) when:
...
```bash
gt mail send website/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
